        ...
        <div className="container mx-auto px-4 max-w-[1400px] relative z-10">
          ...
          <div className="flex flex-col xl:flex-row items-center justify-center gap-8 xl:gap-16">
            ...
            <motion.div 
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="grid grid-cols-2 gap-x-24 gap-y-1 text-left order-2 xl:order-1 w-full xl:w-auto"
            >
              {leftSideNames.map((name, index) => (
                ...
                >
                  <PixelCard className="p-0 bg-muted/60 border border-border rounded-lg flex items-center justify-center text-center shadow-lg hover:scale-105 hover:border-primary/50 transition-all duration-300 w-fit h-fit">
            ...
            <motion.div 
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="grid grid-cols-2 gap-x-24 gap-y-1 text-left order-3 w-full xl:w-auto"
            >
