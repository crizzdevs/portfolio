        ...
        <div className="container mx-auto px-4 max-w-[1400px] relative z-10">
          ...
          <div className="flex flex-col xl:flex-row items-center justify-center gap-8 xl:gap-16">
            ...
            <motion.div 
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="grid grid-cols-2 gap-x-1 gap-y-4 text-left order-2 xl:order-1 w-full xl:w-auto"
            >
            ...
            <motion.div 
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="grid grid-cols-2 gap-x-1 gap-y-4 text-left order-3 w-full xl:w-auto"
            >
