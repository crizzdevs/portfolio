...
const familyMembers = [
  {
    ...
    name: "Jenny R. Abuan",
    age: "52 years old",
    details: "Owner of 4Js Cakes and Delicacies. A passionate baker creating custom cakes and sweets. Thankyou for your sacrifices Mama!",
    icon: ChefHat,
    color: "text-pink-500",
    image: motherImg,
  },
  {
    ...
    age: "58 years old",
    details: "Self-employed Freelance Carpenter. Skilled in woodworking, construction, and custom builds. The man I aspire to be someday.",
    icon: Hammer,
  ...
  },
  {
    ...
    age: "20 years old",
    details: "3rd Year College at Mallig Plains Colleges. Bachelor of Secondary Education Major in English. Thankyou for being my 24/7 kaaway.",
    icon: BookOpen,
    color: "text-blue-400",
    image: sisterImg,
  },
